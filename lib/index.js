 ...
 * 价格为空闲时段的两倍；自 2026-08-23 00:00（北京时间）起，周六/周日全天
 * 统一按低谷时段价格计费（weekendOffPeak: true）。
 */
export const DEFAULT_PRICING = Object.freeze({
  effectiveAt: '2026-08-23T00:00:00+08:00',
  weekendOffPeak: true,
  peakWindows: [
      ...
      async function routeApi(body) {
        ...
        switch (action) {
          ...
          case 'setPrices': {
            ...
            if (Array.isArray(prices.peakWindows)) { pricing.peakWindows = prices.peakWindows; changed = true }
